...
{
    /// <summary>
    /// Server connector for Pop protocol. Secure connection to server.
    /// </summary>
    /// <Author>Naveen Kumar</Author>
    class PopConnectorWithSsl : PopConnectorBase
    {
        ...
        protected const string IMAP_BAD_RESPONSE = "-ERR";
        ...
        public PopConnectorWithSsl(string popServerAddress, int port)
            : base(popServerAddress, port)
        {
            try
            {
                ...
                _socket.Connect(popServerAddress, port);
                ...
                objSSLStream.AuthenticateAsClient(popServerAddress);
