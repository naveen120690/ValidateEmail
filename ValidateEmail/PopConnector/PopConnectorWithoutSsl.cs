...
{
    /// <summary>
    /// Server connector for POP protocol. Non secure connection to server
    /// </summary>
    /// <Author>Naveen Kumar</Author>
    internal class PopConnectorWithoutSsl : PopConnectorBase
    {
        ...
        public PopConnectorWithoutSsl(string popServerAddress, int port)
