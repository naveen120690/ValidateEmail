...
{
    /// <summary>
    /// Server connector for Imap protocol. Non secure connection to server
    /// </summary>
    /// <Author>Naveen Kumar</Author>
    internal class ImapConnectorWithoutSsl : ImapConnectorBase
    {
        ...
        public ImapConnectorWithoutSsl(string imapServerAddress, int port) :base(imapServerAddress,port)
        {
            try
            {
